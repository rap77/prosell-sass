...
def upgrade() -> None:
    ...
    op.execute("ALTER INDEX IF EXISTS ix_user_dealers_user_dealer RENAME TO ix_user_branches_user_branch")
...
def downgrade() -> None:
    ...
    op.execute("ALTER INDEX IF EXISTS ix_user_branches_user_branch RENAME TO ix_user_dealers_user_dealer")
