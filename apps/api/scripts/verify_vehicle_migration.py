...
async def verify_migration(database_url: str) -> None:
    ...
    async with async_session_maker() as session:
        ...
        for i, product in enumerate(products, 1):
            ...
            print(f"      Make/Model: {attrs.get('make', 'N/A')} {attrs.get('model', 'N/A')} {attrs.get('year', 'N/A')}")
            print(f"      Mileage: {attrs.get('mileage', 'N/A')} {attrs.get('mileage_unit', 'miles')}")
