...
class TestAppointment:
    ...
    def test_create_appointment_minimal(self):
        ...
        assert appointment.product_id == product_id
    ...
    def test_conflict_detection_different_branch_same_time(self):
        """Test conflict detection - different branch, same time should succeed."""
        lead_id = uuid4()
        user_id = uuid4()
        product_id = uuid4()
        tenant_id = uuid4()
        ...
        # Create second appointment with different branch
        lead_id_2 = uuid4()
        user_id_2 = uuid4()
        product_id_2 = uuid4()
        ...
        appointment2 = Appointment.create(
            lead_id=lead_id_2,
            user_id=user_id_2,  # Different branch
            product_id=product_id_2,
            tenant_id=tenant_id,
            scheduled_at=scheduled_at,
        ...
        assert appointment2.user_id == user_id_2
