...
async def test_raises_when_owner_email_already_registered(use_case):
    uc, _org_repository, _vertical_repository, user_repository, _invite_use_case = use_case
...
async def test_allows_email_that_belongs_only_to_a_soft_deleted_user(use_case):
    uc, org_repository, _vertical_repository, user_repository, invite_use_case = use_case
