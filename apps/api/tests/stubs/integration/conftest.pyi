...
@pytest_asyncio.fixture
async def test_user(
    db_session: AsyncSession, test_organization: OrganizationModel, test_role: RoleModel
) -> AsyncGenerator[UserModel]: ...
@pytest_asyncio.fixture
async def test_seller_user(
    db_session: AsyncSession, test_organization: OrganizationModel, test_seller_role: RoleModel
) -> AsyncGenerator[UserModel]: ...
@pytest_asyncio.fixture
