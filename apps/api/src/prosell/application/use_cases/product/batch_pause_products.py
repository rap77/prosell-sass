...
class BatchPauseProductsUseCase:
    """Pause multiple published products for maintenance."""
    ...
    async def execute(
        ...
        for product_id in unique_ids:
            try:
                ...
                error_code = "invalid_transition" if "Cannot pause" in str(e) else "not_found"
