...
class DealerResponse(BaseModel):
    ...
    def from_entity(cls, dealer: Dealer) -> "DealerResponse":
        ...
        return cls(
            ...
            name=dealer.name,
            slug=dealer.slug,
            logo_url=None,  # Dealer entity doesn't have logo_url field
            address=dealer.location_address,
            city=dealer.location_city,
            state=dealer.location_state,
            country=None,  # Dealer entity doesn't have country field
            postal_code=dealer.location_zip,
            phone=None,  # Dealer entity doesn't have phone field
            email=None,  # Dealer entity doesn't have email field
            website=None,  # Dealer entity doesn't have website field
            timezone=dealer.timezone,
            settings=dealer.settings,
            latitude=dealer.location_lat,
            longitude=dealer.location_lng,
