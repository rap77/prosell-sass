    ...
    return (
      ...
      >
        ...
        >
          ...
          <h1 style={{ margin: "16px 0 8px", fontSize: 20, fontWeight: 700, color: "var(--ps-text-primary)" }}>
            Enlace inválido
          </h1>
          <p style={{ margin: 0, color: "var(--ps-text-secondary)" }}>
            El enlace de invitación no es válido. Pedile al staff que te envíe uno nuevo.
          </p>
        </div>
      </div>
    );
        ...
        >
          ...
          {(state === "form" || state === "loading" || state === "error") && (
            ...
            >
              ...
              {fieldError && (
                <p style={{ margin: 0, fontSize: 13, color: "var(--ps-error)" }} role="alert">
                  {fieldError}
                </p>
              )}
