...
const NOTIFICATION_OPTIONS = [
  ...
  },
  {
    ...
    description: 'Notificaciones cuando una publicación cambia de estado en Facebook Marketplace.',
    defaultOn:   false,
  },
  {
    id:          'pipeline-updates',
...
export default function SettingsNotificationsPage() {
  ...
  const toggle = (id: string, value: boolean) => setStates((prev) => ({ ...prev, [id]: value }))
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
              ...
              <div style={{
                ...
                height: 32,
                borderRadius: 8,
                background: states[option.id] ? 'rgba(77,184,255,0.12)' : 'var(--ps-bg-surface)',
                ...
                <Bell
                  size={14}
                  strokeWidth={2}
                  style={{ color: states[option.id] ? 'var(--ps-cyan)' : 'var(--ps-text-disabled)' }}
                />
              </div>
              ...
              <div>
                ...
                <p style={{ margin: '3px 0 0', fontSize: 12, color: 'var(--ps-text-secondary)', lineHeight: 1.5 }}>
                  {option.description}
                </p>
              </div>
            </div>
      ...
      <p style={{
        ...
        Las preferencias se guardan localmente por ahora. La integración con el backend de notificaciones estará disponible próximamente.
      </p>
