...
import { useDealerStats } from "@/lib/api/dealers";
...
export function DealerStatsCard({ dealerId, dealerName }: DealerStatsCardProps) {
  const { data: stats, isLoading, error } = useDealerStats(dealerId);
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-destructive">
            Failed to load dealer statistics
          </p>
        </CardContent>
      </Card>
    );
