              ...
              <div style={{ position: "relative", zIndex: 1, maxWidth: 1280, margin: "0 auto" }}>
                ...
                <div className="ps-ft-row" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center", marginBottom: 100 }}>
                  ...
                  <div className="ps-ft-mock" style={{ position: "relative", display: "flex", justifyContent: "center", alignItems: "center", minHeight: 380 }}>
                    ...
                    <div style={{ position: "relative", width: "100%", maxWidth: 480, background: "rgba(13,27,62,0.7)", border: "1px solid rgba(77,184,255,0.12)", borderRadius: 16, backdropFilter: "blur(20px)", boxShadow: "0 0 60px rgba(77,184,255,0.08), 0 16px 48px rgba(6,13,36,0.55)", padding: 22, color: "#F0F4FF" }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
                        <span style={{ fontSize: 14, fontWeight: 600 }}>Nueva publicación</span>
                        <span style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "3px 10px", borderRadius: 100, background: "rgba(34,211,160,0.14)", color: "#22D3A0", fontSize: 11, fontWeight: 600 }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 14, background: "rgba(6,13,36,0.5)", border: "1px solid rgba(77,184,255,0.08)", borderRadius: 12, padding: 12, marginBottom: 16 }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ fontSize: 15, fontWeight: 700, color: "#4DB8FF", letterSpacing: "-0.01em" }}>$28.500</div>
                        </div>
                      </div>
                      {/* Channel grid */}
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 18 }}>
                        {[
                          ...
                          <div key={ch.label} style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 10, border: "1px solid rgba(77,184,255,0.08)", background: "rgba(6,13,36,0.4)", fontSize: 12, fontWeight: 600 }}>
                            ...
                            <span style={{ width: 18, height: 18, borderRadius: "50%", background: "#22D3A0", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11.5, color: "#8A9BBF" }}>
                        <span style={{ color: "#22D3A0", fontWeight: 600 }}>4/4 canales publicados</span>
                        <span>00:01:48</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="ps-ft-mock" style={{ position: "relative", display: "flex", justifyContent: "center", alignItems: "center", minHeight: 380 }}>
                    ...
                    <div style={{ position: "relative", width: "100%", maxWidth: 480, background: "rgba(13,27,62,0.7)", border: "1px solid rgba(77,184,255,0.12)", borderRadius: 16, backdropFilter: "blur(20px)", boxShadow: "0 0 60px rgba(77,184,255,0.08), 0 16px 48px rgba(6,13,36,0.55)", padding: 22, color: "#F0F4FF" }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
                        ...
                        <span style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "3px 10px", borderRadius: 100, background: "rgba(77,184,255,0.14)", color: "#4DB8FF", fontSize: 11, fontWeight: 600 }}>
                          <span style={{ width: 6, height: 6, borderRadius: "50%", background: "currentColor" }} />
                          12 nuevos
                        </span>
                      </div>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 1, background: "rgba(77,184,255,0.06)", borderRadius: 12, overflow: "hidden", marginBottom: 14 }}>
                        {[
                          ...
                          <div key={l.name} style={{ display: "flex", alignItems: "center", gap: 12, padding: "11px 12px", background: "rgba(6,13,36,0.5)" }}>
                            ...
                            <span style={{ fontSize: 10.5, fontWeight: 600, display: "inline-flex", alignItems: "center", gap: 5, whiteSpace: "nowrap", color: l.ok ? "#22D3A0" : "#F5A623" }}>
                              <span style={{ width: 6, height: 6, borderRadius: "50%", background: "currentColor" }} />
                              {l.status}
                            </span>
                          </div>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", background: "rgba(6,13,36,0.6)", border: "1px solid rgba(77,184,255,0.2)", borderRadius: 12 }}>
                        <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.08em", padding: "2px 6px", borderRadius: 4, background: "rgba(77,184,255,0.15)", color: "#4DB8FF" }}>IA</span>
                        <span style={{ flex: 1, fontSize: 13, color: "#8A9BBF" }}>Responder con IA…</span>
                  ...
                  <div className="ps-ft-mock" style={{ position: "relative", display: "flex", justifyContent: "center", alignItems: "center", minHeight: 380 }}>
                    ...
                    <div style={{ position: "relative", width: "100%", maxWidth: 480, background: "rgba(13,27,62,0.7)", border: "1px solid rgba(77,184,255,0.12)", borderRadius: 16, backdropFilter: "blur(20px)", boxShadow: "0 0 60px rgba(77,184,255,0.08), 0 16px 48px rgba(6,13,36,0.55)", padding: 22, color: "#F0F4FF" }}>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 14 }}>
                        {[
                          ...
                          <div key={m.v} style={{ background: "rgba(6,13,36,0.5)", border: "1px solid rgba(77,184,255,0.08)", borderRadius: 10, padding: "10px 12px" }}>
                            ...
                            <div style={{ fontSize: 10.5, color: "#8A9BBF", marginTop: 2 }}>{m.l}</div>
                          </div>
                        ))}
                      </div>
                      {/* Insight */}
                      <div style={{ display: "flex", alignItems: "flex-start", gap: 10, padding: "10px 12px", background: "rgba(77,184,255,0.06)", border: "1px solid rgba(77,184,255,0.3)", borderRadius: 10, fontSize: 12, lineHeight: 1.5 }}>
                        <div style={{ width: 22, height: 22, borderRadius: 6, flexShrink: 0, background: "rgba(77,184,255,0.15)", color: "#4DB8FF", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        ...
                        <span><strong style={{ color: "#4DB8FF", fontWeight: 700 }}>Insight:</strong> Facebook trae 2x más cierres que AutoTrader este mes.</span>
                      </div>
                    </div>
                  </div>
                </div>
