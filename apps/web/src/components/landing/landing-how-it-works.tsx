  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: "radial-gradient(50% 35% at 50% 0%, rgba(77,184,255,0.06), transparent 60%)",
        }}
      />
      ...
      <div className="relative z-[1] max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-3 gap-8 mb-14">
          {STEPS.map((step) => (
            <div key={step.num} className="ps-hw-step">
              ...
              <h3 className="text-[19px] font-bold tracking-[-0.015em] mb-3">{step.title}</h3>
              <p className="text-sm leading-relaxed text-muted-foreground mb-5">{step.desc}</p>
        ...
        <div className="text-center">
          <span className="text-[15px] text-muted-foreground mr-5">¿Listo para probarlo sin riesgos?</span>
          <Link href="/auth/register" className="ps-btn-primary py-[11px] px-[22px] text-sm">
            Empezar gratis →
          </Link>
        </div>
      </div>
