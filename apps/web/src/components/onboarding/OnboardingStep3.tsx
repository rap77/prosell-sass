    ...
    <>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: 16, fontWeight: 700, color: 'var(--ps-text-primary)' }}>
              Invitá a tu equipo
            </h2>
            <p style={{ margin: '2px 0 0', fontSize: 13, color: 'var(--ps-text-secondary)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              <label
                ...
                style={{ display: 'block', fontSize: 13, fontWeight: 500, color: 'var(--ps-text-primary)', marginBottom: 6 }}
              >
            ...
            <div style={{
              ...
              <strong style={{ color: 'var(--ps-text-primary)' }}>Configuración → Equipo</strong>
