  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <span style={{ fontSize: 12, fontWeight: 500, color: 'var(--ps-text-secondary)' }}>
          Paso {currentStep} de {totalSteps}
        </span>
        <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--ps-cyan)' }}>
          {percent}%
        </span>
      </div>
      ...
      <div style={{
        ...
        <div
          style={{
            ...
            width: `${percent}%`,
            borderRadius: 99,
            background: 'linear-gradient(90deg, var(--ps-cyan), var(--ps-blue))',
