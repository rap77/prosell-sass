...
bundle = {
    ...
    "agent_prompt_template": (
        ...
        "- Recalculate time tracking after each checkpoint\n"
        "- Notify with sound when the parent block completes\n"
        "- Finish with review → verify-criteria → safe-commit\n"
...
echo "  4. Recalculate time tracking after each checkpoint and notify on block completion"
echo "  5. Run review → verify-criteria → safe-commit"
