...
test.describe('Layer 2: Lead Lifecycle - Contract Validation', () => {
  ...
  test.describe('POST /api/v1/leads - Create Lead', () => {
    test('L2-01: should create lead with valid data', async ({ authenticatedRequest }) => {
    ...
    test('L2-02: should reject lead with empty buyer_name', async ({ authenticatedRequest }) => {
    ...
    test('L2-03: should reject lead with invalid email format', async ({ authenticatedRequest }) => {
    ...
    test('L2-04: should reject lead with invalid source', async ({ authenticatedRequest }) => {
    ...
    test('L2-05: should accept lead with special characters in name', async ({ authenticatedRequest }) => {
    ...
    test('L2-06: should accept lead with plus sign in email', async ({ authenticatedRequest }) => {
  ...
  test.describe('GET /api/v1/leads - List Leads', () => {
    test('L2-07: should return paginated lead list', async ({ authenticatedRequest }) => {
      // Act: Fetch leads list
      const response = await authenticatedRequest.get('/api/v1/leads?limit=10&offset=0');
    ...
    test('L2-08: should filter leads by status', async ({ authenticatedRequest }) => {
      // Act: Fetch leads with status filter
      const response = await authenticatedRequest.get('/api/v1/leads?status=new');
    ...
    test('L2-09: should filter leads by search term', async ({ authenticatedRequest }) => {
      // Act: Fetch leads with search term
      const response = await authenticatedRequest.get('/api/v1/leads?search=test');
    ...
    test('L2-10: should reject invalid status filter', async ({ authenticatedRequest }) => {
      // Act: Attempt to fetch leads with invalid status
      const response = await authenticatedRequest.get('/api/v1/leads?status=invalid-status');
  ...
  test.describe('GET /api/v1/leads/{id} - Get Lead Details', () => {
    test('L2-11: should return lead details', async ({ authenticatedRequest }) => {
      ...
      const response = await authenticatedRequest.get(`/api/v1/leads/${leadId}`);
    ...
    test('L2-12: should return 404 for non-existent lead', async ({ authenticatedRequest }) => {
      // Act: Attempt to fetch non-existent lead
      const response = await authenticatedRequest.get('/api/v1/leads/00000000-0000-0000-0000-000000000000');

      // Assert: Should return 404
      expect(response.status()).toBe(404);
    });

    test('L2-13: should return 400 for invalid UUID format', async ({ authenticatedRequest }) => {
      // Act: Attempt to fetch lead with invalid UUID
      const response = await authenticatedRequest.get('/api/v1/leads/not-a-uuid');
  ...
  test.describe('PUT /api/v1/leads/{id} - Update Lead Status', () => {
    test('L2-14: should update lead status to contacted', async ({ authenticatedRequest }) => {
      // Arrange: Create a lead first
      const createResponse = await authenticatedRequest.post('/api/v1/leads', {
        data: {
      ...
      const response = await authenticatedRequest.put(`/api/v1/leads/${leadId}/status`, {
        data: {
    ...
    test('L2-15: should reject invalid status transition', async ({ authenticatedRequest }) => {
    ...
    test('L2-16: should support all valid status values via sequential transitions', async ({ authenticatedRequest }) => {
      ...
      let resp = await authenticatedRequest.put(`/api/v1/leads/${leadId}/status`, {
  ...
  test.describe('Edge Cases & Business Rules', () => {
    test('L2-17: should handle leads without email', async ({ authenticatedRequest }) => {
    ...
    test('L2-18: should handle leads without phone', async ({ authenticatedRequest }) => {
    ...
    test('L2-19: should handle message with emojis and special chars', async ({ authenticatedRequest }) => {
    ...
    test('L2-20: should handle very long buyer name', async ({ authenticatedRequest }) => {
    ...
    test('L2-21: should reject buyer name exceeding 255 chars', async ({ authenticatedRequest }) => {
    ...
    test('L2-22: should handle message with newlines and tabs', async ({ authenticatedRequest }) => {
