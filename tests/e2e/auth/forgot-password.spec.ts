...
test.describe("Forgot Password", () => {
  ...
  test.describe("Page Layout", () => {
    test(
      "should display forgot password page elements correctly",
  ...
  test.describe("Password Reset Flow", () => {
    test(
      "should submit reset request with valid email",
  ...
  test.describe("Navigation", () => {
    test(
      "should navigate to login page when clicking back to login link",
