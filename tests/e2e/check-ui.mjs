...
async function checkUI() {
  ...
  try {
    ...
    await page.screenshot({
      path: "screenshots/ui-check/01-login.png",
      fullPage: true,
    });
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: "screenshots/ui-check/02-register.png",
      fullPage: true,
    });
    console.log("   ✅ Screenshot saved");
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: "screenshots/ui-check/03-forgot-password.png",
      fullPage: true,
    });
    console.log("   ✅ Screenshot saved");
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: "screenshots/ui-check/04-reset-password.png",
      fullPage: true,
    });
    console.log("   ✅ Screenshot saved");
    ...
    await page.waitForLoadState("networkidle");
    await page.screenshot({
      path: "screenshots/ui-check/05-verify-email.png",
      fullPage: true,
    });
    console.log("   ✅ Screenshot saved");
