...
> **ProSell** is a B2B SaaS sales intelligence platform. Style: *dark premium SaaS.* Mood references: Linear (cleanliness), Attio (sales context), Stripe (gradient depth).
...
/* Status */
--success: #22D3A0;  --warning: #F5A623;  --error: #F04438;
```
