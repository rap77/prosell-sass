      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            ...
            <span className="text-primary fw-600">{fmt(total)} total ARR</span>
          </p>
        </div>
          ...
          <tbody>
            {DEALS.map((d) => (
              <tr key={d.id} onClick={() => onOpenDeal(d.id)}>
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: "100%",
                          background:
                            "linear-gradient(90deg, #4DB8FF, #1E5FD4)",
                        }}
                      ></div>
                    </div>
                  </div>
                ...
                <td>
                  <span className={d.days > 14 ? "text-error fw-600" : ""}>
                    {d.days}
                  </span>
                </td>
