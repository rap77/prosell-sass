      ...
      <div className="two-col">
          ...
          <div className="timeline">
            <div className="timeline-item">
              ...
              <div className="timeline-what">
                <strong>Marcus Lee</strong> opened your last email and clicked
                the proposal link 3×.
              </div>
            </div>
            <div className="timeline-item">
              ...
              <div className="timeline-what">
                Pricing page visited by 3 unique users from acme.com.
              </div>
            </div>
            <div className="timeline-item">
              <div className="timeline-when">Sep 18 · 2:00 PM</div>
              <div className="timeline-what">
                <strong>Sarah Chen</strong> sent the redlined MSA to{" "}
                <strong>David Wu</strong>.
              </div>
            </div>
            <div className="timeline-item muted">
              <div className="timeline-when">Sep 14</div>
              <div className="timeline-what">
                Stage moved to <strong>Negotiation</strong>.
              </div>
            </div>
            <div className="timeline-item muted">
              <div className="timeline-when">Sep 6</div>
              <div className="timeline-what">
                Demo delivered to 6 stakeholders. Recording shared.
              </div>
            </div>
            <div className="timeline-item muted">
              <div className="timeline-when">Aug 28</div>
              <div className="timeline-what">
                Discovery call with <strong>Marcus Lee</strong>. Notes synced
                from Gong.
              </div>
            </div>
          </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ padding: "4px 20px 16px" }}>
              {[
                ...
                >
                  ...
                  >
                    {item.done && (
                      <Icon name="check" size={11} style={{ strokeWidth: 3 }} />
                    )}
                  </span>
                  <div style={{ flex: 1 }}>
                    <div
          ...
          <div className="card card-padded">
            ...
            >
              David Wu (CFO) hasn't engaged in 9 days. Champion{" "}
              <strong>Marcus Lee</strong> just opened your proposal — propose a
              joint review call this week.
            </div>
