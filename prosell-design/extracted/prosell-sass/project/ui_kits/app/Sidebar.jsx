  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-brand">
        ...
        <span style={{ fontSize: 16, fontWeight: 700, letterSpacing: '-0.01em' }}>ProSell</span>
      </div>
      ...
      <div className="sidebar-workspace">
        <div style={{
          ...
          fontWeight: 700, fontSize: 11, color: '#060D24'
        }}>NW</div>
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 13, fontWeight: 600 }}>Northwind Sales</div>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)' }}>Workspace</div>
        </div>
      ...
      <div className="sidebar-section">
        ...
        <Item id="signals" icon="zap" label="Signal inbox" count={counts.signals || 12} />
      ...
      <div className="sidebar-footer">
        ...
        <Icon name="settings" size={15} style={{ color: 'var(--text-secondary)' }} />
      </div>
    </aside>
  );
}
