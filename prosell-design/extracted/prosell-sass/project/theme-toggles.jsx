      ...
      {[
        {
          id: "system",
          label: "Sistema",
          icon: <MonitorIcon size={13} stroke={2.25} />,
        },
        {
          id: "light",
          label: "Claro",
          icon: <SunIcon size={13} stroke={2.25} />,
        },
        {
          id: "dark",
          label: "Oscuro",
          icon: <MoonIcon size={13} stroke={2.25} />,
        },
      ].map((o) => {
        const active = mode === o.id;
        return (
...
function ToggleE({ mode, onChange }) {
  ...
  return (
    ...
    >
      ...
      >
        {dark ? (
          <MoonIcon size={14} stroke={2.25} />
        ) : (
          <SunIcon size={14} stroke={2.25} />
        )}
      </span>
      {dark ? "Oscuro" : "Claro"}
      <span
        style={{ color: dark ? "#8A9BBF" : "#94A0BD", display: "inline-flex" }}
      >
        <svg
          width="10"
          height="10"
