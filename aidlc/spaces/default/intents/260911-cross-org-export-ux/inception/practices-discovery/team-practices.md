# Team Practices — Final, intent `260911-cross-org-export-ux`

**Etapa**: Practices Discovery (re-run) — Step 5 (Lead Integration)
**Baseline leído**: `aidlc/spaces/default/memory/team.md` (afirmado y reconfirmado sin objeción a lo largo de 4 intents previos: `260828-auth-navigation-refactor` → `260911-export-org-selector`).
**Integra**: draft del lead + 3 revisiones ciegas (quality, developer, devsecops) + entrevista humana (Q1, Q2 — ver `practices-discovery-questions.md`).
