...
- **Project**: fix-prosell-ci-seed-data: fix CI seed data breaking the pipeline on main, blocking observability/deployment work
- **Project Type**: Brownfield
- **Scope**: bugfix
- **Start Date**: 2026-08-30T12:58:47Z
- **State Version**: 8
...
- **Next Stage**: none
- **Status**: Completed
- **Last Updated**: 2026-08-30T15:49:46Z
